<?php
    ...
    $this->setCssFile($this->_assetsFolder.'css/grocery-crud-v2.7.9.4fcd039.css');
    ...
    $this->setJavaScriptFile($this->_assetsFolder . 'js/build/grocery-crud-v2.7.9.4fcd039' . $minify_or_not . '.js');
